...
import { getLoyalty, isLogedIn } from '../../../../Services/common';
import { UserContext } from '../../../../Services/userContext';
import { useTranslation } from 'react-i18next';
import { BellIcon, UnverifiedIcon, VerifPendingIcon, VerifiedIcon } from '../../../../assets/svg/svg.jsx';
import CircularProgress from '../../../../Components/Mobile/HeaderLoader/HeaderLoader.jsx';
            ...
            {isLogedIn() ? (
              <>
                ...
                <div className={styles.headerRight}>
                  ...
                  {loyalty && (
                    <CircularProgress
                      progress={(loyalty.balance / loyalty.maxPoint) * 100}
                      imgSrc={`./loyalty/${loyalty.name}.png`}
                    />
                  )}
