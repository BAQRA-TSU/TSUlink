...
import MobileHeaderLogo from "../MobilHeaderLogo/MobileHeaderLogo"
        ...
        <div className={styles.footerComponenet}>
            ...
            <div className={styles.sliderComponent}>
                <div className={styles.slider}>
                    <NavLink className={styles.sliderText} to={"/footer/termsAndConditions"}>{t("terms.conditions")}</NavLink>
                    <NavLink className={styles.sliderText} to={"/footer/rules"}> {t("rules")}</NavLink>
                    <NavLink className={styles.sliderText} to={"/footer/responsibility"}>{t("security.confidentiality.header")}</NavLink>
                </div>
            </div>
            <div className={styles.contactComponent}>
                ...
                <div className={styles.contactElement} onClick={openChat}>
                    <ChatIconFooter />
                    <div className={styles.contactRight}>
                        <p className={styles.contactHeader}>{t("live.chat")}</p>
                        <p className={styles.contactText}>{t("message")}</p>
                    </div>
                </div>
            </div>
