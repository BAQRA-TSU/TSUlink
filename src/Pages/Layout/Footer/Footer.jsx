    ...
    <div className={styles.footerComponenet}>
      <div className={styles.footerHeader}>
        ...
        <div className={styles.socialsComponent}>
          <a rel="noreferrer" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
            <FbIcon />
          </a>
          <a rel="noreferrer" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">
            <InstaIcon />
      ...
      <div className={styles.contactComponent}>
        ...
        <a href="mailto:contact@tsu.link" className={styles.contactElement}>
          <MailIcon />
          <div className={styles.contactRight}>
            <p className={styles.contactHeader}>contact@tsu.link</p>
